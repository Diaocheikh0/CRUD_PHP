        ...
        <table class="table table-bordered border-primary text-center mt-4">
            ...
            <?php foreach ($categories as $c) { ?>
                <tr>
                    ...
                    <td><?= $c->getLibelle() ?></td>
                    <td>
                        <a class="btn btn-primary btn-sm" href="?controller=categorie&&action=edit&id=<?= $c->getId() ?>">Edit</a>
                        <a class="btn btn-danger btn-sm" href="?controller=categorie&&action=delete&id=<?= $c->getId()?>">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
